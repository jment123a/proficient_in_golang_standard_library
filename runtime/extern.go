...
// GOOS 是运行程序的操作系统目标：
// darwin，freebsd，linux等之一。
// 要查看GOOS和GOARCH的可能组合，请运行"go tool dist list"。
const GOOS string = sys.GOOS // 注：当前操作系统

// GOARCH 是正在运行的程序的体系结构目标：
// 386，amd64，arm，s390x等之一。
const GOARCH string = sys.GOARCH // 注：当前处理器架构
